...
# installation de `cartiflette` depuis GitHub:
!pip install py7zr geopandas openpyxl tqdm s3fs  # pour les excercices
!pip install PyYAML xlrd  # pour les excercices
!pip install git+https://github.com/inseefrlab/cartiflette  # pour les excercices
!pip install cartiflette  # pour les excercices

# Import:
import geopandas as gpd
import contextily as ctx  # pour les excercices
import matplotlib.pyplot as plt  # pour les excercices
from cartiflette import carti_download  # pour les excercices
```
