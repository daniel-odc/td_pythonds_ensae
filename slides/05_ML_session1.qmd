...
[The Hundred-Page Machine Learning Book](http://ema.cri-info.cm/wp-content/uploads/2019/07/2019BurkovTheHundred-pageMachineLearning.pdf). <br/> Andriy BurkovAndriy Burkov
...
![ML choice cheatsheet](./img/ml_02_ScikitAlgoChoiceCheatsheet.svg){width="100%"}
...
![ML linear regression](./img/ml_linear_regression.png)
...
![ML logisitc regression](./img/ml_logistic_regression.jpg)
...
![ML SVM](./img/ml_svm.png){width="100%"}
